...
<div class="row align-items-center g-5">
  <div class="col-lg-8">
    ...
    <div class="fw-bold text-brand">ethical,</div> 
    <div class="fw-bold text-brand">relational,</div> 
    <div class="fw-bold text-brand">place-based</div> 
    research</h1>
    <p class="lead text-secondary">
      Wild Fig Research is an independent research consultancy helping public sector and mission-led organisations.
    </p>
...
<div class="row g-4">
  ...
  <div class="col-md-4">
    ...
    <h2 class="h5">Theories of change &amp; outcomes measurement</h2>
...
<p class="mt-4 mb-0">
  <a href="/about/" class="text-decoration-none text-brand fw-medium">
